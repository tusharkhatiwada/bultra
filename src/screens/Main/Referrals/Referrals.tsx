    ...
    <ScrollView>
      <RootView style={[styles.container, { paddingTop: top + space[6] }]}>
          ...
          {status != "" && (
            <View style={styles.statusContainer}>
              ...
              <View style={styles.referralStatus}>
                <Typography size="mini">{status}</Typography>
              </View>
            </View>
          )}
        </View>
        ...
        <Stack space="lg">
          ...
          <View style={[styles.refContainer, { backgroundColor: colors.primary[100] }]}>
            <Typography color="primary.400">{user?.ref ? user?.ref : ""}</Typography>
        ...
        <ReferralLevel
          ...
          goToLevelDetails={goToLevelDetails}
          levelNumber={1}
        />
        <ReferralLevel
